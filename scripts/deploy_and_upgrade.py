from brownie import Box, accounts, config, network, ProxyAdmin, TransparentUpgradeableProxy, Contract, BoxV2
from brownie.network import account
from scripts.helpfull_scripts import get_account, encode_function_data, upgrade
